...
//line page.qtpl:26
	qw422016.N().S(`</head><body onload="DarkThemeLoad();"><nav><div class="nav-title">Computing Fun</div><img src="/client/ico/50.png" alt="Computing Fun" height="50" width="50" class="nav-icon"><a id="nav-link-yt" href="https://www.youtube.com/channel/UCeZQbACMihORscFIwmydpzA" class="nav-link"><span>Channel</span><i class="nav-link-icon fab fa-youtube"></i></a><a id="nav-link-patron" href="https://www.patreon.com/computingfun" class="nav-link"><span>Patron</span><i class="nav-link-icon fab fa-patreon"></i></a><a id="nav-link-game" href="https://www.computingfun.org/games/" class="nav-link"><span>Games</span><i class="nav-link-icon fas fa-gamepad"></i></a><a id="nav-link-article" href="https://www.computingfun.org/articles/" class="nav-link"><span>Articles</span><i class="nav-link-icon far fa-newspaper"></i></a><a id="nav-link-twitch" href="#" class="nav-link"><span>Live</span><i class="nav-link-icon fab fa-twitch"></i></a><a id="nav-link-mode" href="#" onclick="DarkThemeToggle();" class="nav-link"><span> Mode</span><i class="nav-link-icon fas fa-palette"></i></a>`)
//line page.qtpl:38
